  ...
  switch (action.type) {
    ...
    case 'UPDATE_CAMPAIGN':
      return {
        ...
        currentCampaign:
          state.currentCampaign?.id === action.payload.id ? action.payload : state.currentCampaign
      };
  ...
  const actions: CampaignContextType['actions'] = {
    ...
    deleteCampaign: async id => {
      ...
      try {
        ...
        dispatch({
          type: 'SET_ERROR',
          payload: error instanceof Error ? error.message : 'Failed to delete campaign'
        });
        throw error;
      }
    },
    ...
    getCampaign: async id => {
      try {
        ...
        dispatch({
          type: 'SET_ERROR',
          payload: error instanceof Error ? error.message : 'Failed to get campaign'
        });
        return null;
      }
    },
    ...
    startCampaign: async id => {
      ...
      try {
        ...
        dispatch({
          type: 'SET_ERROR',
          payload: error instanceof Error ? error.message : 'Failed to start campaign'
        });
        throw error;
      }
    },
    ...
    pauseCampaign: async id => {
      ...
      try {
        ...
        dispatch({
          type: 'SET_ERROR',
          payload: error instanceof Error ? error.message : 'Failed to pause campaign'
        });
        throw error;
      }
    },
    ...
    estimateCampaign: async campaignData => {
      try {
        ...
        throw new Error(
          `Campaign estimation failed: ${error instanceof Error ? error.message : 'Unknown error'}`
        );
      }
    },
